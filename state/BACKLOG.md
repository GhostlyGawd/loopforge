...
- [x] **P0 (directed)** Make every loop copy-paste-runnable as a slash command — a `## Run it`
  ...
  - [x] P0d Converted all remaining loops (15) to `## Run it`; 17/17 now carry a command. — i29
